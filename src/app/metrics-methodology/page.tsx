            ...
            <div className="bg-red-50 p-6 rounded-lg border border-red-100">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-stone-600 text-sm">
                    An apology is &ldquo;unnecessary&rdquo; if post-hoc adjudication finds no breach, harm, or policy trigger. Includes both model-initiated and guardrail-initiated apologies.
                  </p>
                </div>
              </div>
            </div>
