          ...
          <div className="mt-16 bg-gradient-to-r from-green-50 to-blue-50 p-8 rounded-lg">
            ...
            <div className="text-center mt-8">
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="https://github.com/s8ken/yseeku-platform" target="_blank" rel="noopener noreferrer" className="bg-stone-800 text-white px-6 py-3 rounded-md font-medium hover:bg-stone-900 transition-colors flex items-center justify-center gap-2">
